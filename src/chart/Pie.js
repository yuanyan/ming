 ...
 */
module("chart.Pie",function(){

	//IMPORT
	var Graph = Raphael = module("graph.Raphael"); 
	...
	title: {
		text: "I am title",
		style: {"font-size":20, color:'#333', "font-style":"italic"},
		x: 320,
		y: 100
	},
